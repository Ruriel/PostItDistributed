...
public class UserManager extends JFrame implements Runnable {
	...
	public UserManager(DBObject user, PostItInterface pos) {
		...
		btnAdicionar.addActionListener(new ActionListener() {
			...
			{
				UsernameWindow euw = new UsernameWindow("Adicionar Usuário", (boolean)user.get("adm"));
				int option = -2;
			...
			public void actionPerformed(ActionEvent e) {
				...
				String selected = list.getSelectedValue().replace("(adm) ", "");
					...
					int option = JOptionPane.showOptionDialog(null,
						...
						"Confirma��o", JOptionPane.DEFAULT_OPTION,
				...
				while(option == -2)
				{
					...
					if(option == 0)
					{
						...
						else
						{
							...
							JOptionPane.showMessageDialog(null, "Usuário atualizado com sucesso!", "Usu�rio criado", 
								JOptionPane.INFORMATION_MESSAGE);
						}
					}
				}
